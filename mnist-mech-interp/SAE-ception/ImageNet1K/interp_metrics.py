...
# ACTIVATIONS_BASE_PATH = "./SAE-Results/test-features/baseline/aux-activations-top-25"
# ACTIVATIONS_BASE_PATH = "./SAE-Results/test-features/F0/aux-activations-top-25"
# ACTIVATIONS_BASE_PATH = "./SAE-Results/test-features/F1/aux-activations-top-25"
ACTIVATIONS_BASE_PATH = "./SAE-Results/test-features/F2/aux-activations-top-25"
...
for chunk_path in tqdm(chunk_files, desc="Analyzing Chunks"):
    with np.load(chunk_path) as data:
        ...
        all_sparse_codes.append(data['recon_top'])
        # all_sparse_codes.append(data['recon'])
