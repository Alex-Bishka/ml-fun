...
NUM_EPOCHS = 15
FEATURE_DIM = 1280
MODEL_LOAD_PATH = './classifiers/baseline/vit_h_99.02.pth'
SAE_LOAD_PATH = "./sae_models/baseline/sae_last_layer_l1_0.0004.pth"
RECON_ACT_BASE_PATH = f"./features/classifier"
